export const whatTheFisuniverse25 =
  `The tech team is made up of the first four human subjects that O’Brien snatched. They are the Originals. 

  After many months of comfortable incarceration, they willingly succumbed to their state. Today, all of them have confirmed Stockholm’s syndrome and are totally, devoted to O’Brien!
...
import Max from './assets/Members/Max.svg'
import Harry from './assets/Members/Harry.svg'
import Momo from './assets/Members/Momo.svg'
import Knockers from './assets/Members/Knockers.svg'
import Squid from './assets/Members/Squid.svg'
import TBA from './assets/Members/TBA.svg'
